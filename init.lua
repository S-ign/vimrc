...
vim.keymap.set('n', '<leader>h', vim.lsp.buf.signature_help, { desc = "Open floating diagnostice mssage" })
...
vim.keymap.set("n", "<F10>", ":bd<CR>")
vim.keymap.set("n", "<F12>", ":wa<CR>:terminal dotnet test<CR>")
